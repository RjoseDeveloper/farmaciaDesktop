...
public final class CadastroEntSaid extends javax.swing.JDialog {
    ...
    DefaultTableModel dTableModel = new DefaultTableModel(null, new String[]{"id", "Serie/Lote Nr.", "Data Inicio", "Qtd. Armazem", "Qtd. Loja", "Preco", "Fornecedor", "Add", "Detalhes", "Editar", "Remover"});
...
//        jdfe.setDate(d);
        ...
        this.TableSaida.getColumnModel().getColumn(8).setMaxWidth(50);//setPreferredWidth(3);
...
//        ButtonColumn bces = new ButtonColumn(this.TableSaida, editars, 7, ie);
    ...
    public void mostraSaida() throws Exception {
        ...
        Entrada e =entr;
            ...
            dTableModel2.setValueAt(prec, i, 3);
    ...
    Action deletes = new AbstractAction() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            try {
                ...
                int q1=p.getQpac();
                int q2 = pr.getQtdvenda();
 
                if ((p.getTiposaida().getIdtiposaida() == 3) || (p.getTiposaida().getIdtiposaida() == 1 && q1==q2)) {//Objects.equals(p.getQpac(), pr.getQtdvenda()))) {
                    pr.setQtstock(pr.getQtstock() + p.getQtd());
                ...
                else if (p.getTiposaida().getIdtiposaida() != 4 && p.getTiposaida().getIdtiposaida() != 2) {
                    em.clear();
                    em.getTransaction().commit();
                    JOptionPane.showMessageDialog(null, "Esta Saida nao pode ser removida,\n "
                            + "porque o seu produto ja foi usado na Loja", "Atencao", JOptionPane.WARNING_MESSAGE);
                    return;
                }
                ...
                } else if(p.getTiposaida().getIdtiposaida() != 3 && p.getTiposaida().getIdtiposaida() != 3){
                    em.clear();
                    em.getTransaction().commit();
                    JOptionPane.showMessageDialog(null, "Esta Saida nao pode ser removida,\n "
    ...
    Action editar = new AbstractAction() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            Boolean b = new SaidaJpaController(emf).getSaidaM(p.getEntradaPK().getData());
             System.out.println(p.getQstock()+" "+p.getQpac()+" "+p.getEntradaPK().getData());
            if (b) {
...
//                }
    ...
    private void initComponents() {
        ...
        labelHistory.setText("Gestão de Stock (Armazem e Loja)");
        ...
        jPanel10Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel10Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(cbpro, 0, 265, Short.MAX_VALUE)
                .addGap(18, 18, 18)
        ...
        btEnt.setText("Adicionar Lote ou Serie");
        btEnt.setkBackGroundColor(new java.awt.Color(102, 102, 102));
        btEnt.setkEndColor(new java.awt.Color(0, 153, 153));
        btEnt.setkHoverEndColor(new java.awt.Color(0, 153, 153));
        btEnt.setkHoverForeGround(new java.awt.Color(255, 255, 255));
        btEnt.setkHoverStartColor(new java.awt.Color(255, 102, 0));
        btEnt.setkSelectedColor(new java.awt.Color(0, 102, 102));
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                        .addComponent(btEnt, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        Emprestimo.addTab("Produtos (Lote / Serie)", jDesktopPane1);
        ...
        btSaid.setText("Registar Saida");
        btSaid.setkBackGroundColor(new java.awt.Color(102, 102, 102));
        btSaid.setkEndColor(new java.awt.Color(0, 153, 153));
        btSaid.setkHoverEndColor(new java.awt.Color(0, 153, 153));
        btSaid.setkHoverForeGround(new java.awt.Color(255, 255, 255));
        btSaid.setkHoverStartColor(new java.awt.Color(255, 102, 0));
        btSaid.setkSelectedColor(new java.awt.Color(0, 102, 102));
        ...
        jPanel14Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel14Layout.createSequentialGroup()
                ...
                .addGroup(jPanel14Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel14Layout.createSequentialGroup()
                        .addComponent(btSaid, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(0, 0, Short.MAX_VALUE))))
        );
        ...
        Emprestimo.addTab("Registo de Saidas do (Armazem / Loja)", jPanel14);
...
//        jdfs.setDate(d);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        List<Saida> listaSRel = new ArrayList<>();
        for(Saida s : listaS){
           Saida sd = new Saida(s.getSaidaPK());
           sd.setDatae(s.getDatae());
           Entrada e = new EntradaJpaController(emf).findEntrada(new EntradaPK(s.getProduto().getIdproduto(), s.getDatae()));
           String ser="";
           if(e.getSerie()!=null)ser=e.getSerie();
           String ob = "";
           if(s.getObs()!=null)ob=s.getObs();
           sd.setObs(ser+"|"+ob);
           sd.setPreco(s.getPreco());
           sd.setQpac(s.getQpac());
           sd.setQstock(s.getQstock());
           sd.setQtd(s.getQtd());
           sd.setTiposaida(s.getTiposaida());
           sd.setUtilizador(s.getUtilizador());
           sd.setProduto(s.getProduto());
           listaSRel.add(sd);
        }
        JRBeanCollectionDataSource ds = new JRBeanCollectionDataSource(listaSRel);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try {
            ...
            jpPrint = JasperFillManager.fillReport(path, parametros, ds);//new metodos.ControllerAcess().conetion());
            jv = new JasperViewer(jpPrint, false); //O false eh para nao fechar a aplicacao
            JDialog viewer = new JDialog(new javax.swing.JFrame(), "Stock de Produto", true);
            viewer.setSize(1024, 768);
            viewer.setLocationRelativeTo(null);
            viewer.getContentPane().add(jv.getContentPane());
            viewer.setVisible(true);
    ...
    private void btEntActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEntActionPerformed
        ...
        FormEntrada f = new FormEntrada(new javax.swing.JFrame(), produ, null, "Criar Novo Lote/Serie", client, true);
        f.setVisible(true);
        listaE = new EntradaJpaController(emf).getEntFull((Produto) cbpro.getSelectedItem());//getEntradaPeriodo(jdie.getDate(), null, cbpro.getSelectedItem(), cbfo.getSelectedItem());
        try {
            mostraEntrada();
    ...
    private keeptoo.KButton btEnt;
    private keeptoo.KButton btSaid;
