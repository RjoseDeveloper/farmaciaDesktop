...
public class Proforma extends javax.swing.JDialog {
    ...
    public Proforma(java.awt.Frame parent, List<Produto> pv, List<Produto> p, Detalorg i, String imp,int v, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        labelTitle.setText("DADOS DO CLIENTE");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtnu, javax.swing.GroupLayout.DEFAULT_SIZE, 433, Short.MAX_VALUE)
                            .addComponent(txtn))))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
...
//        }
         ...
         try {
            ss = new SeriefacturaJpaController(emf).addSerie(2);//2 eo id do tipo de serie
        } catch (Exception ex) {
        ...
        for (Produto p : lproe) {
            ...
            Fproforma v = new Fproforma();
            v.setDatavenda(dd);
            v.setDesconto(desc);
            v.setIdvendedor(new Vendedor(this.v));
            ...
            v.setEstado(0);
            v.setNome(txtn.getText());
            v.setNuite(txtnu.getText());
           // v.setCaixa(Integer.parseInt(caxa.getText().substring(1)));
            new FproformaJpaController(emf).create(v);
        }
...
//        }.execute();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Proforma dialog = new Proforma(new javax.swing.JFrame(), pv, p, dog, impprof,v, true);
