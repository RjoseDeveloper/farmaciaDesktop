...
public final class ProdutoExp extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Emprestimo.addTab("Produto-Serie/Lote", jDesktopPane1);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        parametros.clear();
        List<Entrada> listaEnt = new ArrayList<>();
        listaEnt = new EntradaJpaController(emf).getEntExp();//nao deveria fazer refresh para ser igual a da lista
        String prec = "";
        for (Entrada e : listaEnt) {
        ...
        JRBeanCollectionDataSource ds = new JRBeanCollectionDataSource(listaEnt);
