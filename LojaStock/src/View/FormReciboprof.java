...
public class FormReciboprof extends javax.swing.JDialog {
    ...
    public FormReciboprof(java.awt.Frame parent, List<Fproforma> p, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        nome = p.get(0).getNome();
        nuite = p.get(0).getNuite();
        vendaLista.add(" " +nome);
        vendaLista.add(" " + nuite);
        for (Fproforma e : p) {
...
//        }
    ...
    private void initComponents() {
        ...
        labelTitle.setText("Produtos Seleccionados");
    ...
    private void imprActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_imprActionPerformed
       ...
       String pl = new File("saslogo.png").getAbsolutePath();
        parametros.clear();
        parametros.put("cli", nome);// txtClient.getText());
        parametros.put("nuit", nuite );
...
//                    JasperPrintManager.printPage(jasperPrint, 0, false);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormReciboprof dialog = new FormReciboprof(new javax.swing.JFrame(), p, true);
    ...
    public void mostrarResultdo(int i, String prod, float p, int qt, float v) {
        ...
        float total = p * qt;
        vendaLista.add(i + "                                Produto:  " + prod + "                Preço:  " + p + "                  Qtd: " + qt + "                   Total:  " + v);
