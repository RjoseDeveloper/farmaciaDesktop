...
//        }
    ...
    public String addSerie(EntityManager em,int id) throws NonexistentEntityException, Exception {
//        EntityManager em = null;
//        try {
//            em = getEntityManager();
//            em.getTransaction().begin();
        Seriefactura s = em.find(Seriefactura.class, id);
...
//        }
    ...
    public String addSerie(int id) throws NonexistentEntityException, Exception {
        EntityManager em = null;
        try {
            em = getEntityManager();
            em.getTransaction().begin();
